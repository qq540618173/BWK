	...
	<view class="miningdetails">
		...
		<view class="container">
			...
			<view class="price">
				...
				<text class="number" v-if="comboInfo.genre == 2">{{minePrice + 'USDT'}}</text>
				<text class="number" v-if="comboInfo.genre == 1">{{comboInfo.min_price + 'USDT - ' + comboInfo.max_price + 'USDT'}}</text>
			</view>
			<view class="rule">
		...
		<view class="modal" :class="{current: current}">
			...
			<view class="form-item" v-if="comboInfo.genre == 1">
